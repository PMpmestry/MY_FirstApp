 ...
 */
//######################################################This is the one#############################
public class Add_Page1 extends AppCompatActivity implements View.OnKeyListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
...

        {
            ...
            public void onClick(View v) {
                if (isValidate()) {
                    //database
                    Toast.makeText(Add_Page1.this, "Customer details saved", Toast.LENGTH_SHORT).show();
                } /*else {
                    Toast.makeText(Add_Page1.this, "Please complete", Toast.LENGTH_SHORT).show();
                }*/
            }
        });
    }
